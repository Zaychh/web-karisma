    ...
    <div className="flex min-h-screen bg-black text-white">
      ...
      <aside className="w-64 bg-[#1a1a1a] px-4 py-6 border-r border-gray-700">
        ...
        <nav className="space-y-4 text-sm">
          ...
          <div>
            <p className="text-gray-400 uppercase mb-1">Introduction to My SQL</p>
          ...
          <div>
            <p className="text-gray-400 uppercase mb-1">Basic of My SQL</p>
            <ul className="ml-2 border-l border-gray-600 pl-3">
              <li
                className={`cursor-pointer ${
          ...
          <div>
            <p className="text-gray-400 uppercase mb-1">Intermediate My SQL</p>
            <ul className="ml-2 border-l border-gray-600 pl-3">
              <li
                className={`cursor-pointer ${
...
export default CourseDetailMysql;
